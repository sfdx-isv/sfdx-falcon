...
import {SfdxCliActionResultDetail}  from  '../../appx/actions'; // Interface. Represents the core "result detail" info common to every ACTION.
  ...
  protected async executeAction(actionContext:AppxEngineActionContext, actionOptions:ActionOptions={}):Promise<SfdxFalconResult> {
    ...
    const sfdxCommandDef = {
      ...
      commandFlags: {
        ...
        FLAG_DEFINITIONFILE:        path.join(actionContext.projectContext.configPath, actionOptions.scratchDefJson as string),
